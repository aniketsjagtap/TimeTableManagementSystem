...
print_r($res);
*/
//$select_options['entry.faculty'] = $res->next_row_keyed();

//print_r($select_options['entry.faculty']);

$datalist_options = array();
// Instead of restricting the user to a fixed set of options using $selec(_optionselect_options['entry.faculty']);
...
$sql = "SELECT name FROM "._tbl('faculty');
$res = db()->query_array($sql);
print_r($res);
//$select_options['entry.faculty'] = $res;
*/
